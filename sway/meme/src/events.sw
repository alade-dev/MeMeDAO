...
pub struct ThresholdReachedEvent {
    /// The address of the user who triggered the DAO initialization by buying/selling or hitting the threshold.
    pub buyer: Identity,
    /// The total value that was reached, leading to the DAO being initialized.
    pub total_value: u64,
}
