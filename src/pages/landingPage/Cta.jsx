...
const Cta = () => {
  return (
    <div className="relative w-full mx-auto py-16 bg-[#14141D] flex justify-center">
      ...
      <div className="w-[90%] h-[700px] relative max-w-7xl mt-24  flex justify-center bg-gradient-to-r from-gray-300/20  to-gray-500/20  bg-transparent border  border-fuchsia-300/20  rounded-3xl shadow-lg p-8">
        ...
        <div className="flex flex-col  lg:flex-row gap-8">
          ...
          <div className="lg:w-1/2 flex flex-col pt-14">
            ...
            <p className="text-[#D9D9D9] text-xl font-light mt-14 mb-9">
