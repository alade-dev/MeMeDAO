...
function createBytes(value: string): { buf: { ptr: Uint8Array, cap: number }, len: number } {
...
export function createString(value: string): { bytes: { buf: { ptr: Uint8Array, cap: number }, len: number } } {
